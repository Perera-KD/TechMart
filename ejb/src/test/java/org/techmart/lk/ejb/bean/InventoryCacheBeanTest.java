...
public class InventoryCacheBeanTest {
    ...
    public void testCacheHitAndMissHandling() {
        ...
        assertEquals(10, stock);
        assertEquals(1, inventoryCache.getMisses());
        assertEquals(1, inventoryCache.getHits());
        assertEquals(0.5, inventoryCache.getCacheHitRate());
    }
    ...
    public void testDecrementStockFailure() {
        ...
        boolean success = inventoryCache.decrementStock(1L, 8);
        assertFalse(success);
        assertEquals(5, inventoryCache.getStock(1L));
    }
}
